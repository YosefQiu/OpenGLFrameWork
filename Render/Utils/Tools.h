...
inline void display_2x2(glm::mat2 m2)
{
	std::cout << "mat[2x2]" << std::endl;
...
inline void display_3x3(glm::mat3 m3)
{
	std::cout << "mat[3x3]" << std::endl;
...
inline void display_vec2(glm::vec2 v3)
{
	std::cout << "vec2" << "\n| " << v3.x << '\t'
		<< v3.y << '\t'  << std::endl;
}
inline void display_vec2(float* v3)
{
	std::cout << "vec2" << "\n| " << v3[0] << '\t'
		<< v3[1] << '\t' << std::endl;
}
